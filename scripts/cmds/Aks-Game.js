...
module.exports = {
  config: {
    ...
    category: "العاب",
    shortDescription: {
      ar: "خمن الكلمة ضد الكلمة المعطاة"
    },
    longDescription: {
      ar: "يقوم بإعطائك هذا الكود كلمة ويجب أن تعرف عكسها لتفةز"
    },
    guide: {
  ...
  onStart: async function ({ message, event, commandName }) {
    ...
    message.reply(` ▪︎ |ما هو الجواب على السؤال التالي: "${randomQuestionObj.question}" ؟`, (err, info) => {
