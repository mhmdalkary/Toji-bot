...
module.exports = {
  ...
  api.setMessageReaction("🤔", event.messageID, (err) => {}, true);
    ...
    const amount = 10; // قيمة الدفع المطلوبة

    if (userData.money < amount) {
      return api.sendMessage(" ⚠️ |عذراً، ليس لديك ما يكفي من الأموال لإستخدام هذا الأمر يرحى دفع المبلغ 10 دينار 💵 كاش.", event.threadID);
    }
