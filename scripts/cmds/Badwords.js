...
module.exports = {
    config: {
        ...
        longDescription: {
            ...
            ar: "إدارة المستخدمين  من طرف البوت"
        },
        category: "المالك",
        guide: {
        ...
        commands: [
            {
                ...
                description: {
                    ...
                    ar: "قم بتشغيل/إيقاف الحظر التلقائي للمستخدمين الذين ينتهكون لغة حساسة"
                },
                syntax: {
    ...
    onChat: async function ({ args, usersData, message, event, prefix, getLang }) {
        ...
        const sensitiveWords = ["شاذ", "زبي", "انقلع","بوت فاشل","بوت خرا","بوت غبي","بوت حمار","فاشل","قود","بوت كرنج"];
