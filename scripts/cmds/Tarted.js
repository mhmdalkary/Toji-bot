...
module.exports = {
  config: {
    ...
    category: "العاب",
    shortDescription: {
      ar: "حل رموز الكلمة المعطاة خلال فترة زمنية محددة"
    },
    longDescription: {
      ar: "لعبة حيث عليك حل رموز كلمة معينة خلال فترة زمنية محددة للفوز بالجائزة"
    },
    guide: {
      ar: "{prefix}لعبة_الكلمات - ابدأ لعبة إعادة ترتيب الكلمات"
    }
  },
